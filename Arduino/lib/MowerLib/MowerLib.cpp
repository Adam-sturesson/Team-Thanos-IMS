...
/*
------------------------------------------------------------------------------------------
-------------------------------Me Ultrasonic Sensor related functions---------------------
------------------------------------------------------------------------------------------
*/

/*
  Global variables related to Me Ultrasonic Sensor.
*/
MeUltrasonicSensor ultrasonic_10(10);
bool UltrasonicSensor(int distance)
{


  if (ultrasonic_10.distanceCm()<distance)
    return true;
